		...
		load: function() {
			...
			findFiles(src, {
				...
				cb: function(fn) {
					...
					} else if(typeof route !== 'object' || !('GET' in route || 'POST' in route || 'init' in route)) {
						throw new TypeError('route "' + fn + '" needs to return a ' +
							'function or an object with an init function or GET/POST handler.');
					}
